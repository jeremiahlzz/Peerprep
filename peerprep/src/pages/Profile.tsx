        ...
        try {
            const url =
                process.env.REACT_APP_ENV === "development"
                    ...
                    : `https://user-service-${process.env.CLOUD_RUN_PROJECT_ID}.asia-southeast1.run.app/update-profile`;
            ...
            try {
                const url =
                    process.env.REACT_APP_ENV === "development"
                        ...
                        : `https://user-service-${process.env.CLOUD_RUN_PROJECT_ID}.asia-southeast1.run.app/delete-account`;
                const response = await fetch(url, {
                    method: "DELETE",
                    headers: {
                        "Content-Type": "application/json",
